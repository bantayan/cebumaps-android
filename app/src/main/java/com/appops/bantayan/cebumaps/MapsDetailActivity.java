 ...
 * more than a {@link MapsDetailFragment}.
 */
public class MapsDetailActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            getFragmentManager().beginTransaction()
                    .add(R.id.maps_detail_container, fragment)
                    .commit();
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            navigateUpTo(new Intent(this, MapsListActivity.class));
            return true;
        }
